...
/*
 * assumes mesh.tex_polygons.size() and mesh.tex_coordinates.size() are both 1
 * assumes mesh.tex_coordinates contains desired uv mapping for generated texture (generated by UVAtlas)
 *
